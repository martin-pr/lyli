...
namespace {
	 ...
	 *   4B - padding?
	 */
	Lyli::Filesystem::FileListEntry parseLine(Lyli::Camera *camera, const uint8_t *line) {
		...
		return Lyli::Filesystem::FileListEntry(camera, dirBase, dirId, fileBase, fileId, sha1, time);
	}
}
